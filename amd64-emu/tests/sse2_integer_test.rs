...
fn test_paddb() {
    ...
    let code = vec![
        ...
        // Data at offset 0x1020: XMM0 initial value
        0x10, 0x20, 0x30, 0x40, 0x50, 0x60, 0x70, 0x80,
        0x90, 0xA0, 0xB0, 0xC0, 0xD0, 0xE0, 0xF0, 0xFF,
        
        // Data at offset 0x1030: XMM1 value
...
fn test_paddw() {
    ...
    let code = vec![
        ...
        // Data at offset 0x1020: XMM0 initial value (8 words)
        0x00, 0x10,  // 0x1000
        0x00, 0x20,  // 0x2000  
        0x00, 0x30,  // 0x3000
        0x00, 0x40,  // 0x4000
...
fn test_paddd() {
    ...
    let code = vec![
        ...
        // Data at offset 0x1020: XMM0 initial value (4 dwords)
...
fn test_paddq() {
    ...
    let code = vec![
        ...
        // Data at offset 0x1020: XMM0 initial value (2 qwords)
...
fn test_paddb_memory_operand() {
    ...
    let code = vec![
        ...
        // Data at offset 0x1028: Memory operand
        0x10, 0x20, 0x30, 0x40, 0x50, 0x60, 0x70, 0x80,
        0x90, 0xA0, 0xB0, 0xC0, 0xD0, 0xE0, 0xF0, 0xEF,
        
        // Space for result at offset 0x1038
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ];
...
fn test_psubb() {
    ...
    let code = vec![
        ...
        // Data at offset 0x1030: XMM1 value (values to subtract)
...
fn test_pand() {
    ...
    let code = vec![
        ...
        0x55, 0x55, 0x55, 0x55, 0x0F, 0x0F, 0x0F, 0x0F,
        
        // Data at offset 0x1030: XMM1 value
        0x0F, 0x0F, 0x0F, 0x0F, 0xFF, 0xFF, 0xFF, 0xFF,
        0xAA, 0xAA, 0xAA, 0xAA, 0xF0, 0xF0, 0xF0, 0xF0,
...
fn test_pandn() {
    ...
    let code = vec![
        ...
        0xAA, 0xAA, 0xAA, 0xAA, 0x0F, 0x0F, 0x0F, 0x0F,
        
        // Data at offset 0x1030: XMM1 value
        0x0F, 0x0F, 0x0F, 0x0F, 0xFF, 0xFF, 0xFF, 0xFF,
        0x55, 0x55, 0x55, 0x55, 0xF0, 0xF0, 0xF0, 0xF0,
...
fn test_pxor() {
    ...
    let code = vec![
        ...
        0xAA, 0xAA, 0xAA, 0xAA, 0x12, 0x34, 0x56, 0x78,
...
fn test_pxor_self() {
    ...
    let code = vec![
        // Initialize XMM0 with non-zero values
        0x66, 0x0F, 0x6F, 0x05, 0x10, 0x00, 0x00, 0x00,  // movdqa xmm0, [rip + 0x10]
        // PXOR xmm0, xmm0 (zero the register)
        0x66, 0x0F, 0xEF, 0xC0,  // pxor xmm0, xmm0
        // Move result to memory for checking
        0x66, 0x0F, 0x7F, 0x05, 0x10, 0x00, 0x00, 0x00,  // movdqa [rip + 0x10], xmm0
        
        // Data at offset 0x1018
    ...
    // Execute instructions
    assert!(engine.emu_start(0x1000, 0x1000 + 0x10, 0, 0).is_ok());
    
    // Check result - should be all zeros
    let mut result = vec![0u8; 16];
    engine.mem_read(0x1018, &mut result).unwrap();
