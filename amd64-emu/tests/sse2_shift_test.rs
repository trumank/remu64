...
fn test_psllw() {
    ...
    let code = vec![
        ...
        // Data at offset 0x1018: XMM0 initial value (8 words)
...
fn test_pslld() {
    ...
    let code = vec![
        ...
        // Data at offset 0x1018: XMM0 initial value (4 dwords)
        0x11, 0x11, 0x11, 0x11,
        0x22, 0x22, 0x22, 0x22,
        0x33, 0x33, 0x33, 0x33,
        0x44, 0x44, 0x44, 0x44,
    ...
    assert_eq!(u32::from_le_bytes([result[0], result[1], result[2], result[3]]), 0x11111100);
    assert_eq!(u32::from_le_bytes([result[4], result[5], result[6], result[7]]), 0x22222200);
    assert_eq!(u32::from_le_bytes([result[8], result[9], result[10], result[11]]), 0x33333300);
    assert_eq!(u32::from_le_bytes([result[12], result[13], result[14], result[15]]), 0x44444400);
}
...
fn test_psllq() {
    ...
    let code = vec![
        ...
        // Data at offset 0x1018: XMM0 initial value (2 qwords)
...
fn test_psrlw() {
    ...
    let code = vec![
        ...
        // Data at offset 0x1018: XMM0 initial value (8 words)
        0x10, 0x11, 0x20, 0x22, 0x40, 0x44, 0x80, 0x88,
...
fn test_psrld() {
    ...
    assert_eq!(u32::from_le_bytes([result[0], result[1], result[2], result[3]]), 0x00111111);
    assert_eq!(u32::from_le_bytes([result[4], result[5], result[6], result[7]]), 0x00222222);
    assert_eq!(u32::from_le_bytes([result[8], result[9], result[10], result[11]]), 0x00444444);
    assert_eq!(u32::from_le_bytes([result[12], result[13], result[14], result[15]]), 0x00888888);
}
...
fn test_psrad() {
    ...
    assert_eq!(u32::from_le_bytes([result[0], result[1], result[2], result[3]]), 0x00111111);
    assert_eq!(u32::from_le_bytes([result[4], result[5], result[6], result[7]]), 0x00222222);
    assert_eq!(u32::from_le_bytes([result[8], result[9], result[10], result[11]]), 0xFF800000);  // Sign extended
    assert_eq!(u32::from_le_bytes([result[12], result[13], result[14], result[15]]), 0xFFFFFFFF);  // All 1s
}
...
fn test_shift_overflow() {
    ...
    let code = vec![
        ...
        // Data at offset 0x1018: XMM0 initial value (all 1s)
