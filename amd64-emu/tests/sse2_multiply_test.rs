...
fn test_pmuludq() {
    ...
    let code = vec![
        ...
        0x00, // 0x10000000 (low dword), ignored (high dword)
        0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00, 0x00,
        0x00, // 0xFFFFFFFF (low dword), ignored (high dword)
        // Data at offset 0x102C: XMM1 multipliers (low dwords of each qword)
        0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00,
        0x00, // 0x02000000 (low dword), ignored (high dword)
        0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00,
        0x00, // 0x00010000 (low dword), ignored (high dword)
        // Space for result at offset 0x103C
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00,
    ];
...
fn test_pmullw_memory_operand() {
    ...
    let code = vec![
        // Initialize XMM0 with test values (loads from 0x1008 + 0x10 = 0x1018)
        0x66, 0x0F, 0x6F, 0x05, 0x10, 0x00, 0x00, 0x00, // movdqa xmm0, [rip + 0x10]
        // PMULLW xmm0, [rip + 0x18] - multiply with memory operand (loads from 0x1010 + 0x18 = 0x1028)
        0x66, 0x0F, 0xD5, 0x05, 0x18, 0x00, 0x00, 0x00, // pmullw xmm0, [rip + 0x18]
        // Move result to memory for checking (stores to 0x1018 + 0x20 = 0x1038)
        0x66, 0x0F, 0x7F, 0x05, 0x20, 0x00, 0x00, 0x00, // movdqa [rip + 0x20], xmm0
        // Data at 0x1018: XMM0 initial value
        0x0A, 0x00, 0x14, 0x00, 0x1E, 0x00, 0x28, 0x00, // 10, 20, 30, 40
        0x32, 0x00, 0x3C, 0x00, 0x46, 0x00, 0x50, 0x00, // 50, 60, 70, 80
        // Data at 0x1028: Memory operand (multipliers)
        0x02, 0x00, 0x03, 0x00, 0x04, 0x00, 0x05, 0x00, // 2, 3, 4, 5
        0x06, 0x00, 0x07, 0x00, 0x08, 0x00, 0x09, 0x00, // 6, 7, 8, 9
        // Result space at 0x1038
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00,
    ];
    ...
    // Check result
    // The final movdqa stores to [rip + 0x20]
