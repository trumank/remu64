...
fn test_psadbw() {
    ...
    assert_eq!(result & 0xFFFF_FFFF_FFFF_0000, 0, "PSADBW should clear bits [63:16]");
    assert_eq!(result & 0xFFFF_0000_0000_0000_0000_0000_0000_0000, 0, "PSADBW should clear bits [127:80]");
}