...
impl<H: HookManager<M>, M: MemoryTrait> ExecutionContext<'_, H, M> {
    ...
    fn execute_vaddpd(&mut self, inst: &Instruction) -> Result<()> {
    ...
    fn execute_vmulpd(&mut self, inst: &Instruction) -> Result<()> {
    ...
    fn execute_vdivpd(&mut self, inst: &Instruction) -> Result<()> {
    ...
    fn execute_vorps(&mut self, inst: &Instruction) -> Result<()> {
    ...
    fn execute_vorpd(&mut self, inst: &Instruction) -> Result<()> {
