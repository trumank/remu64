...
fn test_shld_basic() {
    ...
    let code = vec![
        ...
        0x48, 0xbb, 0x55, 0xaa, 0x55, 0xaa, 0x55, 0xaa, 0x55, 0xaa, // mov rbx, 0xAA55AA55AA55AA55
...
fn test_shrd_basic() {
    ...
    let code = vec![
        0x48, 0xb8, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // mov rax, 0x0000000000000001
        0x48, 0xbb, 0x55, 0xaa, 0x55, 0xaa, 0x55, 0xaa, 0x55, 0xaa, // mov rbx, 0xAA55AA55AA55AA55
