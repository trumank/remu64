...
fn test_pext_32bit() {
    ...
    let code = vec![
        0x48, 0xB8, 0x80, 0x70, 0x60, 0x50, 0xFF, 0xFF, 0xFF, 0xFF,  // mov rax, 0xFFFFFFFF50607080
        0x48, 0xBB, 0xF0, 0xF0, 0xF0, 0xF0, 0xFF, 0xFF, 0xFF, 0xFF,  // mov rbx, 0xFFFFFFFFF0F0F0F0
...
fn test_pext_memory_source() {
    ...
    engine.memory.write(0x2000, &0xF0F0u64.to_le_bytes()).unwrap();
