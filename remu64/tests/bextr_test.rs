...
fn test_bextr_basic() {
    ...
    let code = vec![
        0xC4, 0xE2, 0x60, 0xF7, 0xC8,  // bextr ecx, eax, ebx (vvvv=0011 inverted = 1100 = 0x60 bits[6:3])
        0x90,                           // nop
    ];
...
fn test_bextr_memory_operand() {
    ...
    let code = vec![
        0xC4, 0xE2, 0x60, 0xF7, 0x0C, 0x25, 0x00, 0x20, 0x00, 0x00,  // bextr ecx, [0x2000], ebx (vvvv=ebx)
        0x90,                                                           // nop
    ];
