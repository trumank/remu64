...
fn test_blsi_basic() {
    ...
    let code = vec![
        ...
        0xC4, 0xE2, 0xF8, 0xF3, 0xD8,              // blsi rbx, rax (VEX.LZ.0F38.F3 /3)
    ];
...
fn test_blsi_powers_of_two() {
    ...
    let code = vec![
        ...
        0xC4, 0xE2, 0xF8, 0xF3, 0xD8,              // blsi rbx, rax
        
        // Test with 8
        0x48, 0xC7, 0xC0, 0x08, 0x00, 0x00, 0x00,  // mov rax, 0x08
        0xC4, 0xE2, 0xF8, 0xF3, 0xD0,              // blsi rdx, rax
        
        // Test with 0x80
        0x48, 0xC7, 0xC0, 0x80, 0x00, 0x00, 0x00,  // mov rax, 0x80
        0xC4, 0xE2, 0xF8, 0xF3, 0xC8,              // blsi rcx, rax
    ];
...
fn test_blsi_32bit() {
    ...
    let code = vec![
        ...
        0xC4, 0xE2, 0x78, 0xF3, 0xD8,              // blsi ebx, eax (32-bit VEX.LZ.0F38.F3 /3)
    ];
...
fn test_blsi_memory_operand() {
    ...
    let code = vec![
        0xC4, 0xE2, 0xF8, 0xF3, 0x1C, 0x25, 0x00, 0x20, 0x00, 0x00,  // blsi rbx, qword ptr [0x2000] (VEX.LZ.0F38.F3 /3)
    ];
...
fn test_blsi_sign_flag() {
    ...
    let code = vec![
        ...
        0xC4, 0xE2, 0x78, 0xF3, 0xD8,              // blsi ebx, eax
    ];
