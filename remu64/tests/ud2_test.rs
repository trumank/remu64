use remu64::{Engine, EngineMode, Permission, Register, memory::MemoryTrait, EmulatorError};
...
fn test_ud2_stops_execution() {
    ...
    assert_eq!(counter[0], 1, "Counter should be 1 (only incremented before UD2)");
}
