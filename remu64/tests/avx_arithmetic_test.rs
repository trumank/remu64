...
fn test_vdivps_xmm() {
    ...
    let xmm1_data: u128 = (12.0_f32.to_bits() as u128)
...
fn test_vaddpd_xmm() {
    ...
    let xmm1_data: u128 = (1.5_f64.to_bits() as u128) | ((2.5_f64.to_bits() as u128) << 64);

    // XMM2 = [3.5, 4.5]
    let xmm2_data: u128 = (3.5_f64.to_bits() as u128) | ((4.5_f64.to_bits() as u128) << 64);
...
fn test_vsubpd_xmm() {
    ...
    // XMM1 = [10.5, 20.5]
    let xmm1_data: u128 = (10.5_f64.to_bits() as u128) | ((20.5_f64.to_bits() as u128) << 64);

    // XMM2 = [0.5, 5.5]
    let xmm2_data: u128 = (0.5_f64.to_bits() as u128) | ((5.5_f64.to_bits() as u128) << 64);
...
fn test_vaddps_ymm() {
    ...
    let ymm2_low: u128 = (2.0_f32.to_bits() as u128)
        | ((2.0_f32.to_bits() as u128) << 32)
...
fn test_vmulpd_xmm() {
    ...
    let xmm1_data: u128 = (3.0_f64.to_bits() as u128) | ((4.0_f64.to_bits() as u128) << 64);

    // XMM2 = [2.0, 5.0]
    let xmm2_data: u128 = (2.0_f64.to_bits() as u128) | ((5.0_f64.to_bits() as u128) << 64);
...
fn test_vdivpd_xmm() {
    ...
    let xmm1_data: u128 = (20.0_f64.to_bits() as u128) | ((15.0_f64.to_bits() as u128) << 64);

    // XMM2 = [4.0, 3.0]
    let xmm2_data: u128 = (4.0_f64.to_bits() as u128) | ((3.0_f64.to_bits() as u128) << 64);
...
fn test_vmulpd_ymm() {
    ...
    let ymm1_low: u128 = (1.5_f64.to_bits() as u128) | ((2.5_f64.to_bits() as u128) << 64);
    let ymm1_high: u128 = (3.5_f64.to_bits() as u128) | ((4.5_f64.to_bits() as u128) << 64);

    // YMM2 = [2.0, 3.0, 4.0, 2.0]
    let ymm2_low: u128 = (2.0_f64.to_bits() as u128) | ((3.0_f64.to_bits() as u128) << 64);
    let ymm2_high: u128 = (4.0_f64.to_bits() as u128) | ((2.0_f64.to_bits() as u128) << 64);
    ...
    assert_eq!(
        (result[0] >> 64) & 0xFFFFFFFFFFFFFFFF,
        7.5_f64.to_bits() as u128
    );
    assert_eq!(result[1] & 0xFFFFFFFFFFFFFFFF, 14.0_f64.to_bits() as u128);
    assert_eq!(
        (result[1] >> 64) & 0xFFFFFFFFFFFFFFFF,
        9.0_f64.to_bits() as u128
    );
}
...
fn test_vdivpd_ymm() {
    ...
    let ymm1_low: u128 = (15.0_f64.to_bits() as u128) | ((21.0_f64.to_bits() as u128) << 64);
    let ymm1_high: u128 = (14.0_f64.to_bits() as u128) | ((18.0_f64.to_bits() as u128) << 64);

    // YMM2 = [3.0, 7.0, 2.0, 6.0]
    let ymm2_low: u128 = (3.0_f64.to_bits() as u128) | ((7.0_f64.to_bits() as u128) << 64);
    let ymm2_high: u128 = (2.0_f64.to_bits() as u128) | ((6.0_f64.to_bits() as u128) << 64);
